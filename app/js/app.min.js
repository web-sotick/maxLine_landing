...
"use strict";document.addEventListener("DOMContentLoaded",function(){console.log("%c > Development: https://vk.com/sotick_yoker","background: #fc342a; padding:7px 7px 7px 0; font-size: 12px; color: #ffffff");var o=document.querySelector(".popup-main"),e=document.querySelector(".promo"),t=document.querySelector(".popup__close-btn"),c=document.querySelector(".promo__info-block_btns button");t.addEventListener("click",function(){o.classList.remove("popup-active"),e.classList.remove("promo-locked")}),c.addEventListener("click",function(){o.classList.add("popup-active"),e.classList.add("promo-locked")})});